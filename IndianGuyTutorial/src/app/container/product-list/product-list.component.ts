...
export class ProductListComponent {
  array =  ['BRECHA - SUSCRIPCIONES', 'ASOCIACION DE ESCRIBANOS- CUOTA SOCIOS', 'OK', 'TIME TOWER- TV CABLE', 'EMMI COOPERATIVA', 'IMM CONTRIB INMOBILIARIA', 'CABLEVISION', 'IMM OTROS TRIBUTOS', 'LA DIARIA', 'RIO URUGUAY CABLE VISION', 'IMM CONVENIOS', 'COLEGIO SAN JOSé DE LA PROVIDENCIA', 'PEU', 'ANTEL MOVIL ONLINE', 'TODOPAGOS', 'COLEGIO SANTA ELENA - MONTEVIDEO', 'AEBU - PAGO DE CAMPING', 'COLEGIO JOSE PEDRO VARELA - PAGO CUOTAS', 'COLEGIO SANTA ELENA - LAGOMAR', 'PUNTA SYSTEMS', 'RECARGA MOVISTAR', 'FACULTAD DE CIENCIAS AGRARIAS UDE- PAGO CUOTA', 'INTENDENCIA DE ARTIGAS - CONVENIOS', 'INASE - INSTITUTO NACIONAL DE SEMILLAS', 'VISION CANARIA - PAGO ONLINE FACTURA', 'PAGO CUOTA ELM', 'GREMEDA', 'CES ALARMAS - SEGURIDAD', 'CAJA DE PROFESIONALES UNIVERSITARIOS CONVENIOS EMPRESAS', 'ADT', 'TCC', 'INMOBILIARIA LARS', 'BSE ONLINE', 'FLACSO', 'IMM TASA ANUAL NECRO', 'UTE ONLINE', 'ANEP - IMPUESTO DE PRIMARIA POR IDENTIFICADOR DE PADRÓN', 'BLESS - SERVICIO DE ACOMPAñANTES', 'IMM TARIFA SANIAMIENTO', 'RECARGA ANTEL', 'CARLOS PICOS - SERVICIOS', 'INTENDENCIA DE ARTIGAS - CONTRIBUCION URBANA', 'CéLULAS DE CORDóN - ALMACENAMIENTO DE CéLULAS MADRE', 'CAJA DE PROFESIONALES UNIVERSITARIOS TRIBUTOS EMPRESAS', 'AGUASDELACOSTA', 'COLEGIO DEL SUR - PAGO DE CUOTAS DE EDUCACION', 'CABLE MAS 33', 'BHU ONLINE', 'AGENCIA NACIONAL DE VIVIENDA', 'COSTA CABLE VISION', 'PANAVOX', 'DESEMBOLSO PRESTAMO ELM', 'CENTRO SOCIAL LA PAZ - PAGO CUOTA SOCIOS', 'MEDICINA PERSONALIZADA - PAGO DE FACTURAS', 'DIRECTV TASA DE CONEXION', 'PARQUE DEL RECUERDO RUTA INTERBALNEARIA', 'COLEGIO SANTA TERESA DE JESUS - PAGO DE CUOTAS EDUCACION', 'ANTEL FIJO ONLINE', 'AM DE SAN JOSE', 'ADMINISTRACIONES ROCO - PAGO DE GASTOS COMUNE', 'CASMER', 'MOVISTAR - PAGO DE FACTURAS', 'MEVIR ONLINE', 'PARQUE DEL RECUERDO RUTA 5', 'COOP ARTIGAS PAGO PRES', 'ANHEC', 'MENTORING', 'VIDEO CABLE SAN CARLOS- TV CABLE', 'INTENDENCIA DE ARTIGAS - CONTRIBUCION RURAL', 'CLARO', 'BPS', 'MULTISEñAL', 'SUCIVE CONVENIO', 'INMOBILIARIA FASCIOLI - GASTOS COMUNES', 'RADIO BUTIA - VENTAS ONLINE', 'CAJA DE PROFESIONALES UNIVERSITARIOS', 'COOPERATIVA VICMAN', 'ADIU- GASTOS COMUNES', 'INMOBILIARIA SANTERINI - GASTOS COMUNES', 'CLUB ATLéTICO TABARE- PAGO CUOTAS', 'CONAPROLE', 'SECRETARIADO URUGUAYO DE LANA - PAGO DE FACTURAS', 'ACOMPANA - SERVICIO DE ACOMPANANTE', 'VIDEO CABLE CASTILLO', 'INSTITUTO CRANDON - PAGO DE CUOTAS EDUCACION', 'IMM TRIBUTO DOM', 'MONTEVIDEO GAS', 'OSE ONLINE', 'ITSS - SEGURIDAD', 'SAMAN', 'RECARGA CLARO', 'ABR ADMINISTRACIONES - GASTOS COMUNES', 'COLEGIO IDEJO - PAGO DE CUOTAS', 'NEW AGE DATA- PAGO DE FACTURAS DE SERVICIO', 'CAMPIGLIA', 'SUAT', 'CABLE PLUS CUOTA', 'HELLE SEGURIDAD', 'CABLEVISION FRAY BENTOS', 'INSTITUTO DE ACTUACIóN DE MONTEVIDEO - PAGO DE CUOTAS',]
  ...
  qntProducts = this.products.length;

  qntProductInStock = this.products.filter( product => product.is_in_inventory === true).length

  qntProductOutOfStock = this.products.filter( product => product.is_in_inventory === false).length

  @Input()
  searchText: string = '';

  // parent component of filter
  selectedFilterRadionBtn: string = 'all';

  onFilterChanged(eventValue : string) {
  console.log('onFiterChanged called');
  console.log(eventValue);
  this.selectedFilterRadionBtn = eventValue;
  }
}
